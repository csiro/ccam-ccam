...
! Copyright 2016-2026 Commonwealth Scientific Industrial Research Organisation (CSIRO)
...
public intsch_mode, freshwaterlake_fix, wt_transport
...
integer, save :: freshwaterlake_fix=1, wt_transport=0
...
real, save :: wbclim_lonn=0., wbclim_lonx=0., wbclim_latn=0., wbclim_latx=0.
