...
!           update tss 
     ...
     &                      +betm(k)*t(1:ifull,k-1)
      ...
      ! Apply convolution to all grid points on my processor
     ...
     &         ifg)
      ...
      if (myid==0) then
        ...
        write(6,*) "Receive arrays from all host processors"
      end if
#endif
      if (myid==hproc) then
        iy=til*npta
        ...
        if(nud_uv>0)then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,klt
                do n=1,til*npta
                  zu(n+ppass*til,k)=dd(n+(k-1)*til*npta
     &               +ppass*til*klt)
                end do
              end do
            end do
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,klt
                do n=1,til*npta
                  zv(n+ppass*til,k)=dd(n+(k-1)*til*npta
     &               +ppass*til*klt)
                end do
              end do
            end do
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,klt
                do n=1,til*npta
                  zw(n+ppass*til,k)=dd(n+(k-1)*til*npta
     &               +ppass*til*klt)
                end do
              end do
            end do
        ...
        if(nud_t>0)then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,klt
                do n=1,til*npta
                  zt(n+ppass*til,k)=dd(n+(k-1)*til*npta
     &               +ppass*til*klt)
                end do
              end do
            end do
        ...
        if(nud_q>0)then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,klt
                do n=1,til*npta
                  zq(n+ppass*til,k)=dd(n+(k-1)*til*npta
     &               +ppass*til*klt)
                end do
              end do
            end do
        ...
        if(nud_uv>0)then
          ...
          if (myid==0) then
            do k=1,klt
              do ppn=0,5
                do n=1,til
                  uu(n+ppn*til,k)=dd(n+til*(k-1)+ppn*til*klt)
                end do
              end do
            end do
          end if
          ...
          if (myid==0) then
            do k=1,klt
              do ppn=0,5
                do n=1,til
                  vv(n+ppn*til,k)=dd(n+til*(k-1)+ppn*til*klt)
                end do
              end do
            end do
          end if
          ...
          if (myid==0) then
            do k=1,klt
              do ppn=0,5
                do n=1,til
                  ww(n+ppn*til,k)=dd(n+til*(k-1)+ppn*til*klt)
                end do
              end do
            end do
          end if
        ...
        if(nud_t>0)then
          ...
          if (myid==0) then
            do k=1,klt
              do ppn=0,5
                do n=1,til
                  tt(n+ppn*til,k)=dd(n+til*(k-1)+ppn*til*klt)
                end do
              end do
            end do
          end if
        ...
        if(nud_q>0)then
          ...
          if (myid==0) then
            do k=1,klt
              do ppn=0,5
                do n=1,til
                  qgg(n+ppn*til,k)=dd(n+til*(k-1)+ppn*til*klt)
                end do
              end do
            end do
          end if
     ...
     &                     qq,lblock,klt,ifg)
      ...
      real, dimension(4*il_g,ioff+1:ioff+ipan,klt) :: au,av,aw,at,aq
      real, dimension(4*il_g,ioff+1:ioff+ipan) :: ap,asum
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,klt) :: pu,pv
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,klt) :: pw
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,klt) :: pt,pq
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan) :: pp,psum
      real, dimension(4*il_g) :: ra,xa,ya,za
      real, dimension(4*il_g*il_g*klt) :: dd
      real, dimension(4*il_g*ipan*klt) :: ff
      logical, intent(in) :: lblock
          ...
          if(nud_uv>0)then
            if (myid==hproc) then
              do k=1,klt
                do j=1,il_g
                  do n=1,me
                    dd(n+me*(k-1)+me*klt*(j-1))=qu(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             0,comm_rows)
            ...
            do k=1,klt
              do j=ns,ne
                do n=1,me
                  au(n,j,k)=ff(n+me*(k-1)+me*klt*(j-ns))
                end do
              end do
            end do
            if (myid==hproc) then
              do k=1,klt
                do j=1,il_g
                  do n=1,me
                    dd(n+me*(k-1)+me*klt*(j-1))=qv(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             0,comm_rows)
            ...
            do k=1,klt
              do j=ns,ne
                do n=1,me
                  av(n,j,k)=ff(n+me*(k-1)+me*klt*(j-ns))
                end do
              end do
            end do
            if (myid==hproc) then
              do k=1,klt
                do j=1,il_g
                  do n=1,me
                    dd(n+me*(k-1)+me*klt*(j-1))=qw(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             0,comm_rows)
            ...
            do k=1,klt
              do j=ns,ne
                do n=1,me
                  aw(n,j,k)=ff(n+me*(k-1)+me*klt*(j-ns))
                end do
              end do
            end do
          end if
          if(nud_t>0)then
            if (myid==hproc) then
              do k=1,klt
                do j=1,il_g
                  do n=1,me
                    dd(n+me*(k-1)+me*klt*(j-1))=qt(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             0,comm_rows)
            ...
            do k=1,klt
              do j=ns,ne
                do n=1,me
                  at(n,j,k)=ff(n+me*(k-1)+me*klt*(j-ns))
                end do
              end do
            end do
          end if
          if(nud_q>0)then
            if (myid==hproc) then
              do k=1,klt
                do j=1,il_g
                  do n=1,me
                    dd(n+me*(k-1)+me*klt*(j-1))=qq(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             0,comm_rows)
            ...
            do k=1,klt
              do j=ns,ne
                do n=1,me
                  aq(n,j,k)=ff(n+me*(k-1)+me*klt*(j-ns))
                end do
              end do
            end do
          end if
     ...
     &      !        -erf(cq*(ra(2:me)-0.5*(ds/rearth)))  ! (correct units are 1/cq)
        ...
        do j=ns,ne
          do n=os,oe
            ff(n-os+1+jpan*(j-ns))=psum(n,j)
          end do
        end do
        call ccmpi_gatherx(dd(1:til),ff(1:ijpan),0,comm_proc)
        if (myid==hproc) then
          do iproc=hproc,hproc+mproc-1
#ifdef uniform_decomp
            call proc_region_dix(iproc,ipoff,jpoff,npoff,nxproc,ipan,
     &                           jpan)
#else
     ...
     &                            nyproc,ipan,jpan,npan)
            ...
            do j=nns,nne
              do n=oos,ooe
                qsum(igrd(n,j))=dd(n-oos+1+jpan*(j-nns)
     &                            +ijpan*(iproc-hproc))
              end do
            end do
          end do
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do j=nns,nne
                do n=oos,ooe
                  qp(igrd(n,j))=dd(n-oos+1+jpan*(j-nns)
     &                            +ijpan*(iproc-hproc))
                end do
              end do
            end do
        ...
        if (nud_uv>0) then
          do k=1,klt
            do j=ns,ne
              do n=os,oe
                ff(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pu(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(dd(1:til*klt),ff(1:ijpan*klt),0,comm_proc)
          if (myid==hproc) then
            do iproc=hproc,hproc+mproc-1
#ifdef uniform_decomp
              call proc_region_dix(iproc,ipoff,jpoff,npoff,nxproc,
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,klt
                do j=nns,nne
                  do n=oos,ooe
                    qu(igrd(n,j),k)=dd(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*klt*(iproc-hproc))
                  end do
                end do
              end do
            end do
          ...
          do k=1,klt
            do j=ns,ne
              do n=os,oe
                ff(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pv(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(dd(1:til*klt),ff(1:ijpan*klt),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,klt
                do j=nns,nne
                  do n=oos,ooe
                    qv(igrd(n,j),k)=dd(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*klt*(iproc-hproc))
                  end do
                end do
              end do
          ...
          do k=1,klt
            do j=ns,ne
              do n=os,oe
                ff(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pw(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(dd(1:til*klt),ff(1:ijpan*klt),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,klt
                do j=nns,nne
                  do n=oos,ooe
                    qw(igrd(n,j),k)=dd(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*klt*(iproc-hproc))
                  end do
                end do
              end do
        ...
        if (nud_t>0) then
          do k=1,klt
            do j=ns,ne
              do n=os,oe
                ff(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pt(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(dd(1:til*klt),ff(1:ijpan*klt),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,klt
                do j=nns,nne
                  do n=oos,ooe
                    qt(igrd(n,j),k)=dd(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*klt*(iproc-hproc))
                  end do
                end do
              end do
        ...
        if (nud_q>0) then
          do k=1,klt
            do j=ns,ne
              do n=os,oe
                ff(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pq(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(dd(1:til*klt),ff(1:ijpan*klt),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,klt
                do j=nns,nne
                  do n=oos,ooe
                    qq(igrd(n,j),k)=dd(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*klt*(iproc-hproc))
                  end do
                end do
              end do
     ...
     &                    lblock,ifg)
      ...
      if (myid==0) then
        write(6,*) "MLO End 1D filter"
        write(6,*) "MLO Receive arrays from host proc"
      end if
#endif
      if (myid==hproc) then
        iy=til*npta*kd
        if (nud_sst/=0) then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,kd
                do n=1,til*npta
                  zp(n+ppass*til,k)=zz(n+(k-1)*til*npta+ppass*til*kd)
                end do
              end do
            end do
          end if
        ...
        if (nud_sss/=0) then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,kd
                do n=1,til*npta
                  zps(n+ppass*til,k)=zz(n+(k-1)*til*npta+ppass*til*kd)
                end do
              end do
            end do
          end if
        ...
        if (nud_ouv/=0) then
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,kd
                do n=1,til*npta
                  zpu(n+ppass*til,k)=zz(n+(k-1)*til*npta+ppass*til*kd)
                end do
              end do
            end do
          end if
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,kd
                do n=1,til*npta
                  zpv(n+ppass*til,k)=zz(n+(k-1)*til*npta+ppass*til*kd)
                end do
              end do
            end do
          end if        
          ...
          if (myid==0) then
            do ppass=0,5,npta
              do k=1,kd
                do n=1,til*npta
                  zpw(n+ppass*til,k)=zz(n+(k-1)*til*npta+ppass*til*kd)
                end do
              end do
            end do
          end if
        ...
        if (nud_sst/=0) then
          ...
          if (myid==0) then
            do k=1,kd
              do ppn=0,5
                do n=1,til
                  diff_g(n+ppn*til,k)=zz(n+(k-1)*til+ppn*til*kd)
                end do
              end do
            end do
          end if
        ...
        if (nud_sss/=0) then
          ...
          if (myid==0) then
            do k=1,kd
              do ppn=0,5
                do n=1,til
                  diffs_g(n+ppn*til,k)=zz(n+(k-1)*til+ppn*til*kd)
                end do
              end do
            end do
          end if
        ...
        if (nud_ouv/=0) then
          ...
          if (myid==0) then
            do k=1,kd
              do ppn=0,5
                do n=1,til
                  diffu_g(n+ppn*til,k)=zz(n+(k-1)*til+ppn*til*kd)
                end do
              end do
            end do
          end if
          ...
          if (myid==0) then
            do k=1,kd
              do ppn=0,5
                do n=1,til
                  diffv_g(n+ppn*til,k)=zz(n+(k-1)*til+ppn*til*kd)
                end do
              end do
            end do
          end if        
          ...
          if (myid==0) then
            do k=1,kd
              do ppn=0,5
                do n=1,til
                  diffw_g(n+ppn*til,k)=zz(n+(k-1)*til+ppn*til*kd)
                end do
              end do
            end do
          end if
     ...
     &             kd,lblock,ifg)
      ...
      real, dimension(4*il_g,ioff+1:ioff+ipan) :: aph,asum
      real, dimension(4*il_g,ioff+1:ioff+ipan,kd) :: ap,aps,apu,apv,apw
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan) :: pph,psum
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,kd) :: pp,pps
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,kd) :: ppu,ppv
      real, dimension(joff+1:joff+jpan,ioff+1:ioff+ipan,kd) :: ppw
      real, dimension(4*il_g*il_g*kd) :: zz
      real, dimension(4*il_g*ipan*kd) :: yy
      logical, intent(in) :: lblock
          ...
          if (nud_sst/=0) then
            if (myid==hproc) then
              do k=1,kd
                do j=1,il_g
                  do n=1,me
                    zz(n+me*(k-1)+me*kd*(j-1))=qp(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             comm_rows)
            ...
            do k=1,kd
              do j=ns,ne
                do n=1,me
                  ap(n,j,k)=yy(n+me*(k-1)+me*kd*(j-ns))
                end do
              end do
            end do
          end if
          if (nud_sss/=0) then
            if (myid==hproc) then
              do k=1,kd
                do j=1,il_g
                  do n=1,me
                    zz(n+me*(k-1)+me*kd*(j-1))=qps(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             comm_rows)
            ...
            do k=1,kd
              do j=ns,ne
                do n=1,me
                  aps(n,j,k)=yy(n+me*(k-1)+me*kd*(j-ns))
                end do
              end do
            end do
          end if
          if (nud_ouv/=0) then
            if (myid==hproc) then
              do k=1,kd
                do j=1,il_g
                  do n=1,me
                    zz(n+me*(k-1)+me*kd*(j-1))=qpu(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             comm_rows)
            ...
            do k=1,kd
              do j=ns,ne
                do n=1,me
                  apu(n,j,k)=yy(n+me*(k-1)+me*kd*(j-ns))
                end do
              end do
            end do
            if (myid==hproc) then
              do k=1,kd
                do j=1,il_g
                  do n=1,me
                    zz(n+me*(k-1)+me*kd*(j-1))=qpv(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             comm_rows)
            ...
            do k=1,kd
              do j=ns,ne
                do n=1,me
                  apv(n,j,k)=yy(n+me*(k-1)+me*kd*(j-ns))
                end do
              end do
            end do
            if (myid==hproc) then
              do k=1,kd
                do j=1,il_g
                  do n=1,me
                    zz(n+me*(k-1)+me*kd*(j-1))=qpw(igrd(n,j),k)
                  end do
                end do
              end do
            end if
     ...
     &             comm_rows)
            ...
            do k=1,kd
              do j=ns,ne
                do n=1,me
                  apw(n,j,k)=yy(n+me*(k-1)+me*kd*(j-ns))
                end do
              end do
            end do
          end if
        ...
        do j=ns,ne
          do n=os,oe
            yy(n-os+1+jpan*(j-ns))=psum(n,j)
          end do
        end do
        call ccmpi_gatherx(zz(1:til),yy(1:ijpan),0,comm_proc)
        if (myid==hproc) then
          do iproc=hproc,hproc+mproc-1
#ifdef uniform_decomp
            call proc_region_dix(iproc,ipoff,jpoff,npoff,nxproc,
     ...
     &                              nyproc,ipan,jpan,npan)
            ...
            do j=nns,nne
              do n=oos,ooe
                qsum(igrd(n,j))=zz(n-oos+1+jpan*(j-nns)
     &                            +ijpan*(iproc-hproc))
              end do
            end do
          end do
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do j=nns,nne
                do n=oos,ooe
                  qph(igrd(n,j))=zz(n-oos+1+jpan*(j-nns)
     &                             +ijpan*(iproc-hproc))
                end do
              end do
            end do
        ...
        if (nud_sst/=0) then
          do k=1,kd
            do j=ns,ne
              do n=os,oe
                yy(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pp(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(zz(1:til*kd),yy(1:ijpan*kd),0,comm_proc)
          if (myid==hproc) then
            do iproc=hproc,hproc+mproc-1
#ifdef uniform_decomp
              call proc_region_dix(iproc,ipoff,jpoff,npoff,nxproc,
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,kd
                do j=nns,nne
                  do n=oos,ooe
                    qp(igrd(n,j),k)=zz(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*kd*(iproc-hproc))
                  end do
                end do
              end do
            end do
        ...
        if (nud_sst/=0) then
          do k=1,kd
            do j=ns,ne
              do n=os,oe
                yy(n-os+1+jpan*(j-ns)+ijpan*(k-1))=pps(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(zz(1:til*kd),yy(1:ijpan*kd),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,kd
                do j=nns,nne
                  do n=oos,ooe
                    qps(igrd(n,j),k)=zz(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*kd*(iproc-hproc))
                  end do
                end do
              end do
        ...
        if (nud_ouv/=0) then
          do k=1,kd
            do j=ns,ne
              do n=os,oe
                yy(n-os+1+jpan*(j-ns)+ijpan*(k-1))=ppu(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(zz(1:til*kd),yy(1:ijpan*kd),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,kd
                do j=nns,nne
                  do n=oos,ooe
                    qpu(igrd(n,j),k)=zz(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*kd*(iproc-hproc))
                  end do
                end do
              end do
          ...
          do k=1,kd
            do j=ns,ne
              do n=os,oe
                yy(n-os+1+jpan*(j-ns)+ijpan*(k-1))=ppv(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(zz(1:til*kd),yy(1:ijpan*kd),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,kd
                do j=nns,nne
                  do n=oos,ooe
                    qpv(igrd(n,j),k)=zz(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*kd*(iproc-hproc))
                  end do
                end do
              end do
          ...
          do k=1,kd
            do j=ns,ne
              do n=os,oe
                yy(n-os+1+jpan*(j-ns)+ijpan*(k-1))=ppw(n,j,k)
              end do
            end do
          end do
          call ccmpi_gatherx(zz(1:til*kd),yy(1:ijpan*kd),0,comm_proc)
     ...
     &                              nyproc,ipan,jpan,npan)
              ...
              do k=1,kd
                do j=nns,nne
                  do n=oos,ooe
                    qpw(igrd(n,j),k)=zz(n-oos+1+jpan*(j-nns)+ijpan*(k-1)
     &                                +ijpan*kd*(iproc-hproc))
                  end do
                end do
              end do
