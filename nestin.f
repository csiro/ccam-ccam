            ...
            do s=1,e
              ...
              do j=ns,ne
                do n=1,nmax
                  ...
                  pp(iq1,p)=qp(iq,p)
                  do k=kbotdav,kl
                    pu(iq1,k,p)=qu(iq,k,p)
                    pv(iq1,k,p)=qv(iq,k,p)
                    pw(iq1,k,p)=qw(iq,k,p)
                    pt(iq1,k,p)=qt(iq,k,p)
                    pq(iq1,k,p)=qq(iq,k,p)
                  end do
                end do
              end do
     ...
     &               MPI_COMM_WORLD,status,ierr)
            ...
            do j=ns,ne
              do n=1,nmax
                ...
                qp(iq,p)=pp(iq1,p)
                do k=kbotdav,kl
                  qu(iq,k,p)=pu(iq1,k,p)
                  qv(iq,k,p)=pv(iq1,k,p)
                  qw(iq,k,p)=pw(iq1,k,p)
                  qt(iq,k,p)=pt(iq1,k,p)
                  qq(iq,k,p)=pq(iq1,k,p)
                end do
              end do
            end do
          end do        
