...
!paracc!$acc declare create(cm0,minl,maxl,mintke,mineps,ce0,ce1,ce2,ce3)
! model MF constants
...
!paracc!$acc declare create(be,ent0,ent1,ent_min,ezmin,entc0,dtrc0,m0,b1,b2,qcmf,mfbeta)
! generic constants
...
!paracc!$acc declare create(buoymeth,tkemeth,stabmeth,maxdts)
...
!paracc!$acc update device(cm0,minl,maxl,mintke,mineps,ce0,ce1,ce2,ce3)
!paracc!$acc update device(be,ent0,ent1,ent_min,ezmin,entc0,dtrc0,m0,b1,b2,qcmf,mfbeta)
!paracc!$acc update device(buoymeth,tkemeth,stabmeth,maxdts)
...
real, dimension(:,:), contiguous, intent(inout) :: qvg,qlg,qfg
real, dimension(:,:), contiguous, intent(out) :: kmo
real, dimension(:,:), contiguous, intent(in) :: zz,zzh
real, dimension(:,:), contiguous, intent(in) :: shear
real, dimension(:,:), contiguous, intent(inout) :: tke
real, dimension(:,:), contiguous, intent(inout) :: eps
real, dimension(:), contiguous, intent(inout) :: zi
real, dimension(:), contiguous, intent(in) :: fg,eg,cduv,ps,rhos,dx
real, dimension(:), contiguous, intent(out) :: ustar_ave
