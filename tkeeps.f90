...
!  see vertmix.f betatt for example).
! (also reinstate shallow convection options by using delthet, x, etc
!  from vertmix in ppb buoyancy term).
do k=2,kl-1
