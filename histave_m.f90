...
allocate(rnet_ave(ifull),wb_ave(ifull,ms),tsu_ave(ifull),alb_ave(ifull),fbeam_ave(ifull))
allocate(psl_ave(ifull))
...
deallocate(rnet_ave,wb_ave,tsu_ave,alb_ave,fbeam_ave)
deallocate(psl_ave)
