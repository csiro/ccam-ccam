...
* --- physical
      parameter (rearth=6.37122e6)
      parameter (r=287.,g=9.80616,cp=1004.64,cpv=1869.46)
      common/consts/roncp   ! derived quantities: see indata.f
* --- chemical
      parameter (fAIR_MolM = 28.965,
     .           fH_MolM   =  1.00794,
     .           fC_MolM   = 12.011,
     .           fO_MolM   = 15.9994,
     .           fS_MolM   = 32.066,
