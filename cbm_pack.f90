...
! ##############################################################################
! Cater for both CASA and IGBP settings   (BP Oct 2007)
! *** when using 13 veg types, will have compilation problem here as there
!     are 16 values on the right hand side. This can only be solved by reading
!     in froot from an external file using DO i=1, mxvt ... etc.
