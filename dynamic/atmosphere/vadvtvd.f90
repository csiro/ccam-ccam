...
interface vadv_work
  module procedure vadv_work3, vadv_work4
end interface
...
subroutine vadv_work3(tarr,nvadh_inv_pass,nits)
...
return
end subroutine vadv_work3

subroutine vadv_work4(tarr,nvadh_inv_pass,nits)
