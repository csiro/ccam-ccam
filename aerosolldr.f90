...
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg A ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
...
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg B ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
...
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg C ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
! Calculate dust emission and turbulent dry deposition at the surface
call dustem(dt,rhoa(:,1),wg,veff,dz(:,1),vt,snowd)
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg D ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
...
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg E ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
...
enddo
if ( any(xtg(1:ifull,1:kl,1:naero)>6.4e-6) ) then
  print *,"xtg F ",maxval(xtg(1:ifull,1:kl,1:naero)),maxloc(xtg(1:ifull,1:kl,1:naero))
end if
...
subroutine dustem(tdt,rhoa,wg,win,dz1,vt,snowd)
...
real, dimension(ifull), intent(in) :: win       !10m windspeed (m/s)
...
real, dimension(ifull) :: u_ts0,u_ts,veff,w10m
...
do n = 1, ndust
  ...
  xtg(1:ifull,1,n+itracdu-1) = (xtg(1:ifull,1,n+itracdu-1)+a*tdt)*exp(-b*tdt)
