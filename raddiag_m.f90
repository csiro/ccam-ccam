...
real, dimension(:), allocatable, save :: sgdn_ave,rgdn_ave,sgdn
...
allocate(sgdn_ave(ifull),rgdn_ave(ifull),sgdn(ifull))
...
deallocate(sgdn_ave,rgdn_ave,sgdn)
