...
!$acc declare create(rkmsave,rkhsave,pblh,fg,condc,condx,conds,condg)
...
allocate( wsgsmax(ifull), wsgs(ifull), ugs_var(ifull) )
...
deallocate( wsgsmax, wsgs, ugs_var )
