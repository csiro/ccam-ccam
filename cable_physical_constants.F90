...
!  REAL(r_1), PARAMETER :: cs = 0.003    ! substrate drag coefficient
  REAL(r_1), PARAMETER :: beta  = crd/csd ! ratio cr/cs
...
!  INTEGER(i_d), PARAMETER :: niter = 8  ! number of iterations for za/L
...
!  REAL(r_1), PARAMETER :: zetneg = -10. ! negative limit on za/L when niter>=3
  REAL(r_1), PARAMETER :: zetneg = -15. ! negative limit on za/L when niter>=3
