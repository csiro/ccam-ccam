...
globpe.o hordifg.o hs_phys.o indata.o infile.o ints.o \
...
netcdf_m.o mpif_m.o aerodata_m.o vertmixdata_m.o
...
stacklimit.o: stacklimit.c
	cc -c stacklimit.c
convjlm.o: convjlm.f
	$(FC) -c $(FFLAGS) $(PPFLAG77) -no-fma -extend-source 132 $<
...
cloudmod.o : cfrac_m.o const_phys.o estab.o kuocomb_m.o morepbl_m.o newmpar_m.o parm_m.o sigs_m.o vertmixdata_m.o vvel_m.o kuocom.h
...
trvmix.o : arrays_m.o cc_mpi.o cable_ccam2.o cable_define_types.o carbpools_m.o cc_mpi.o const_phys.o dates_m.o diag_m.o newmpar_m.o nsibd_m.o parm_m.o pbl_m.o sigs_m.o tracermodule.o tracers_m.o vertmixdata_m.o  xyzinfo_m.o 
