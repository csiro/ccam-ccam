...
scrnout.o : arrays_m.o cc_mpi.o const_phys.o diag_m.o estab.o liqwpar_m.o mlo.o morepbl_m.o newmpar_m.o nsibd_m.o parm_m.o pbl_m.o permsurf_m.o prec_m.o screen_m.o sigs_m.o soil_m.o soilsnow_m.o work2_m.o
