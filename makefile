...
globpe.o config_m.o gdrag_m.o hordifg.o hs_phys.o indata.o infile.o ints.o \
...
cable_ccam_file.o : cable_ccam_common.o carbpools_m.o cc_mpi.o darcdf_m.o infile.o newmpar_m.o nsibd_m.o parm_m.o parmgeom_m.o pbl_m.o soil_m.o soilsnow_m.o vegpar_m.o
...
hordifg.o : aerosol_arrays.o arrays_m.o cc_mpi.o cfrac_m.o const_phys.o dpsdt_m.o indices_m.o kuocom_m.o liqwpar_m.o map_m.o newmpar_m.o nharrs_m.o parm_m.o parmdyn_m.o parmhdff_m.o savuvt_m.o sigs_m.o tkeeps.o vecsuv_m.o vvel_m.o
