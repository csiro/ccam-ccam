...
FFLAGS = -O -xHost -ftz -fpp -I $(NETCDF_ROOT)/include -assume buffered_io -Dsimple_timer -Duniform_decomp -Dsumdd -check all -debug all
...
infile.o : cc_mpi.o netcdf_m.o dates.h newmpar.h parm.h
