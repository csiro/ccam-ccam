...
uclem.o uclem_ctrl.o mlo_ctrl.o mlo.o river.o tkeeps.o \
...
longwave_params.o longwave_tables.o lw_gases_stdtf.o map_m.o microphys_rad.o mlo_ctrl.o mlo.o \
...
hordifg.o : aerointerface.o arrays_m.o cc_acc.o cc_mpi.o cfrac_m.o const_phys.o dpsdt_m.o indices_m.o kuocom_m.o liqwpar_m.o map_m.o newmpar_m.o nharrs_m.o parm_m.o parmdyn_m.o parmhdff_m.o savuvt_m.o sigs_m.o tkeeps.o vecsuv_m.o vvel_m.o
hs_phys.o : arrays_m.o latlong_m.o newmpar_m.o nlin_m.o parm_m.o sigs_m.o
indata.o : aerointerface.o amipsst.o arrays_m.o bigxy4_m.o cc_mpi.o const_phys.o convjlm.o convjlm22.o darcdf_m.o dates_m.o daviesnudge.o diag_m.o eig.o ensemble.o epst_m.o extraout_m.o filnames_m.o gdrag_m.o indices_m.o infile.o kuocom_m.o latlong_m.o latltoij.o liqwpar_m.o map_m.o mlo_ctrl.o mlodynamics.o morepbl_m.o newmpar_m.o nharrs_m.o nsibd_m.o onthefly.o parm_m.o parmdyn_m.o parmgeom_m.o pbl_m.o permsurf_m.o river.o seaesfrad.o sflux.o sigs_m.o soil_m.o soilsnow_m.o soilv_m.o stime_m.o timeseries.o tracermodule.o tracers_m.o uclem_ctrl.o vecs_m.o vecsuv_m.o vegpar_m.o vertmix.o xyzinfo_m.o
...
module_aux_cosp.o : arrays_m.o cc_mpi.o cfrac_m.o cloudmod.o const_phys.o estab.o kuocom_m.o latlong_m.o liqwpar_m.o map_m.o module_aux_rad.o morepbl_m.o newmpar_m.o nharrs_m.o parm_m.o pbl_m.o prec_m.o raddiag_m.o sigs_m.o soil_m.o soilsnow_m.o work3f_m.o vvel_m.o
...
onthefly.o : aerointerface.o cc_acc.o cc_mpi.o const_phys.o darcdf_m.o diag_m.o extraout_m.o histave_m.o infile.o kuocom_m.o latlong_m.o latltoij.o mlo_ctrl.o mlodynamics.o morepbl_m.o newmpar_m.o nharrs_m.o nsibd_m.o parm_m.o parmdyn_m.o parmgeom_m.o prec_m.o raddiag_m.o riverarrays_m.o savuvt_m.o savuv1_m.o screen_m.o setxyz.o sflux.o sigs_m.o soil_m.o soilv_m.o stime_m.o tkeeps.o tracers_m.o uclem_ctrl.o utilities.o vecsuv_m.o vvel_m.o workglob_m.o work2_m.o xarrs_m.o
optical_path.o : cc_mpi.o filnames_m.o longwave_params.o lw_gases_stdtf.o rad_utilities.o
outcdf.o : aerointerface.o arrays_m.o cc_mpi.o cfrac_m.o cloudmod.o const_phys.o dates_m.o daviesnudge.o dpsdt_m.o extraout_m.o filnames_m.o gdrag_m.o histave_m.o infile.o kuocom_m.o latlong_m.o leoncld.o liqwpar_m.o map_m.o mlo_ctrl.o mlodynamics.o module_aux_rad.o module_ctrl_microphysics.o morepbl_m.o newmpar_m.o nharrs_m.o nsibd_m.o ozoneread.o parm_m.o parmdyn_m.o parmgeom_m.o parmhdff_m.o parmhor_m.o parmvert_m.o pbl_m.o prec_m.o raddiag_m.o river.o riverarrays_m.o savuvt_m.o savuv1_m.o screen_m.o sflux.o seaesfrad.o sigs_m.o soil_m.o soilsnow_m.o soilv_m.o staguv.o tkeeps.o tracermodule.o tracers_m.o uclem_ctrl.o vegpar_m.o vvel_m.o work2_m.o xarrs_m.o version.h
...
trvmix.o : arrays_m.o cable_ccam2.o cable_define_types.o carbpools_m.o cc_mpi.o const_phys.o dates_m.o diag_m.o morepbl_m.o newmpar_m.o nsibd_m.o parm_m.o pbl_m.o sigs_m.o tracermodule.o tracers_m.o vertmix.o xyzinfo_m.o 
...
vertmix.o : arrays_m.o cc_mpi.o carbpools_m.o cfrac_m.o const_phys.o diag_m.o estab.o extraout_m.o kuocom_m.o liqwpar_m.o map_m.o mlo_ctrl.o morepbl_m.o newmpar_m.o nharrs_m.o nsibd_m.o parm_m.o pbl_m.o savuvt_m.o screen_m.o sigs_m.o soil_m.o soilsnow_m.o tkeeps.o work2_m.o
zenith.o : parm_m.o
