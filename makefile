...
cu_gf_deep.o calculate_mconv_m.o
...
cu_gf_deep.o: cu_gf_deep.F90
	$(FC) -c -O2 -assume byterecl -ftz -fp-model precise -no-fma -DSNY_DEBUG -traceback $(MPIFLAG) $(PPFLAG90) $<
version.h: FORCE
	rm -f tmpver
...
calculate_mconv_m.o : arrays_m.o cc_mpi.o indices_m.o kuocom_m.o map_m.o newmpar_m.o parm_m.o 
