...
vertmix.o icefall.o leoncld.o newcloud.o newrain.o latltoij.o \
...
newcloud.o : cc_mpi.o diag_m.o estab.o sigs_m.o const_phys.h cparams.h kuocom.h newmpar.h parm.h params.h 
