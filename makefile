...
FFLAGS = -O2 $(FHOST) -fbacktrace $(MPIFLAG) $(NCFLAG) $(OMPFLAG)
FOVERRIDE = 
ZMM = 
IPFLAG = 
IPOFLAG =
...
module_aux_cosp.o module_mp_sbu_ylin.o \
...
module_ctrl_microphysics.o module_aux_cosp.o module_mp_sbu_ylin.o \
...
module_aux_cosp.o : aerointerface.o arrays_m.o cc_mpi.o cc_omp.o cfrac_m.o cloudmod.o const_phys.o estab.o filnames_m.o kuocomb_m.o latlong_m.o leoncld.o liqwpar_m.o map_m.o mgcloud.o module_aux_rad.o morepbl_m.o newmpar_m.o nharrs_m.o parm_m.o pbl_m.o prec_m.o raddiag_m.o screen_m.o sflux.o sigs_m.o soil_m.o soilsnow_m.o vvel_m.o work3f_m.o kuocom.h
