...
cable_air.o cable_albedo.o cable_canopy.o cable_carbon.o cable_ccam2.o cable_ccam3.o cable_common.o \
...
cable_canopy.o cable_carbon.o cable_ccam2.o cable_ccam3.o cable_common.o cable_data.o \
...
cc_mpi.o : const_phys.o indices_m.o latlong_m.o map_m.o mpif_m.o newmpar_m.o sumdd_m.o vecsuv_m.o workglob_m.o xyzinfo_m.o
