...
fst88.o hconst.o lwr88.o ozoneread.o resetd.o spa88.o \
...
indata.o : aerointerface.o arrays_m.o ateb.o bigxy4_m.o cable_ccam2.o cable_physical_constants.o cc_mpi.o dava_m.o diag_m.o epst_m.o extraout_m.o gdrag_m.o indices_m.o latlong_m.o liqwpar_m.o map_m.o mlo.o morepbl_m.o nharrs_m.o nsibd_m.o pbl_m.o permsurf_m.o sigs_m.o soil_m.o soilsnow_m.o timeseries.o tracermodule.o tracers_m.o vecs_m.o vecsuv_m.o vegpar_m.o  work3sav_m.o xyzinfo_m.o const_phys.h darcdf.h dates.h filnames.h newmpar.h parm.h parmdyn.h parmgeom.h soilv.h stime.h trcom2.h
infile.o : cc_mpi.o dates.h newmpar.h parm.h
ints.o : cc_mpi.o indices_m.o newmpar.h parm.h parmhor.h
latltoij.o : utilities.o const_phys.h newmpar.h parm.h parmdyn.h
leoncld.o : aerointerface.o arrays_m.o cc_mpi.o diag_m.o kuocomb_m.o latlong_m.o liqwpar_m.o morepbl_m.o nlin_m.o prec_m.o sigs_m.o soil_m.o tracers_m.o vvel_m.o const_phys.h cparams.h establ.h kuocom.h newmpar.h parm.h params.h
...
mlodynamics.o : arrays_m.o bigxy4_m.o cable_ccam2.o cc_mpi.o indices_m.o infile.o latlong_m.o map_m.o mlo.o nsibd_m.o soil_m.o soilsnow_m.o vecsuv_m.o xyzinfo_m.o const_phys.h newmpar.h parm.h soilv.h
mslp.o : cc_mpi.o sigs_m.o const_phys.h newmpar.h parm.h
nestin.o : arrays_m.o cc_mpi.o davb_m.o diag_m.o indices_m.o latlong_m.o map_m.o mlo.o pbl_m.o savuvt_m.o savuv1_m.o soil_m.o soilsnow_m.o vecsuv_m.o xyzinfo_m.o const_phys.h darcdf.h dates.h newmpar.h parm.h parmgeom.h stime.h
...
onthefly.o : aerosolldr.o ateb.o carbpools_m.o cc_mpi.o cable_define_dimensions.o infile.o latlong_m.o mlo.o mlodynamics.o morepbl_m.o nsibd_m.o screen_m.o sigs_m.o soil_m.o tkeeps.o tracers_m.o utilities.o vecsuv_m.o vvel_m.o workglob_m.o const_phys.h darcdf.h newmpar.h parm.h parmgeom.h soilv.h stime.h
optical_path.o : longwave_params.o lw_gases_stdtf.o rad_utilities.o
outcdf.o : aerosolldr.o arrays_m.o ateb.o cable_ccam2.o cable_define_dimensions.o carbpools_m.o cc_mpi.o cfrac_m.o dpsdt_m.o extraout_m.o histave_m.o infile.o latlong_m.o liqwpar_m.o map_m.o mlo.o mlodynamics.o morepbl_m.o nharrs_m.o nsibd_m.o parmhdff_m.o pbl_m.o prec_m.o raddiag_m.o screen_m.o sigs_m.o soil_m.o soilsnow_m.o tkeeps.o tracermodule.o tracers_m.o vegpar_m.o vvel_m.o work2_m.o const_phys.h dates.h filnames.h kuocom.h newmpar.h parm.h parmdyn.h parmgeom.h parmhor.h parmvert.h soilv.h trcom2.h version.h
...
radriv90.o : aerointerface.o arrays_m.o ateb.o cable_ccam2.o cc_mpi.o cfrac_m.o cldcom_m.o co2dta_m.o diag_m.o extraout_m.o infile.o kdacom_m.o kuocomb_m.o latlong_m.o liqwpar_m.o lwout_m.o mlo.o nsibd_m.o ozoneread.o pbl_m.o raddiag_m.o radisw_m.o rdflux_m.o sigs_m.o soil_m.o soilsnow_m.o srccom_m.o swocom_m.o swr99.o tabcom_m.o tfcom_m.o work3f_m.o work3lwr_m.o zenith.o const_phys.h establ.h kuocom.h newmpar.h parm.h soilv.h rdparm.h hcon.h
retopo.o : cc_mpi.o diag_m.o sigs_m.o const_phys.h newmpar.h parm.h
scrnout.o : arrays_m.o cc_mpi.o diag_m.o liqwpar_m.o morepbl_m.o nsibd_m.o pbl_m.o permsurf_m.o prec_m.o screen_m.o sigs_m.o soil_m.o soilsnow_m.o work2_m.o const_phys.h establ.h newmpar.h parm.h
