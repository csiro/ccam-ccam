...
indata.o : aerointerface.o amipsst.o arrays_m.o bigxy4_m.o cc_mpi.o const_phys.o convjlm.o convjlm22.o darcdf_m.o dates_m.o daviesnudge.o diag_m.o eig.o ensemble.o epst_m.o extraout_m.o filnames_m.o gdrag_m.o indices_m.o infile.o kuocom_m.o latlong_m.o latltoij.o liqwpar_m.o map_m.o mlodynamics.o module_ctrl_turbmix.o morepbl_m.o newmpar_m.o nharrs_m.o nsibd_m.o onthefly.o parm_m.o parmdyn_m.o parmgeom_m.o pbl_m.o permsurf_m.o river.o seaesfrad.o sflux.o sigs_m.o soil_m.o soilsnow_m.o soilv_m.o stime_m.o timeseries.o tracermodule.o tracers_m.o vecs_m.o vecsuv_m.o vegpar_m.o xyzinfo_m.o
...
trvmix.o : arrays_m.o cable_ccam2.o cable_define_types.o carbpools_m.o cc_mpi.o const_phys.o dates_m.o diag_m.o morepbl_m.o newmpar_m.o nsibd_m.o parm_m.o pbl_m.o sigs_m.o tracermodule.o tracers_m.o xyzinfo_m.o 
