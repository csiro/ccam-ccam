!Copyright (c) 2016-2017 by Atmospheric and Environmental Research, Inc. (AER). 
!Software designed and tested in collaboration with the National Severe Storms 
!Laboratory, Norman, Oklahoma. 
!Documentation provided in Adams-Selin, R. and C. Ziegler, 2016: Forecasting hail 
!using a one-dimensional hail growth model within WRF. Mon. Wea. Rev., 144, 4919-4939.
...
!    ! ---------------------------------------------------
!    DO j = jms, jme !jts, jte
!      DO i = ims, ime !its, ite
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE hailstone_driver ( TCA, h1d, ht, PA, rho1d,&
    ...
    REAL(kind=8) DD, D, D_ICE  ! hail diameter (m)
