...
integer, parameter :: itrbgn   =2  ! number of iterations relaxing the solution after restriction
integer, parameter :: itrend   =2  ! number of iterations relaxing the solution after interpolation
