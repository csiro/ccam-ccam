...
integer, parameter :: mstagf =0     ! alternating staggering (0=off left, -1=off right, >0 alternating) - value of 18+ works okay
...
if (mstagf==0) then
  ...
  ltest=mod(ktau-koff-nstagoffmlo,mstagf)==0
end if
if (ltest) then
...
if (mstagf==0) then
  ...
  ltest=mod(ktau-zoff-nstagoffmlo,mstagf)==0
end if
if (ltest) then
